...
namespace _0x5f_QtQuickAppTute_Main_qml { 
...
namespace _0x5f_QtQuickAppTute_Page_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appQtQuickAppTute)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appQtQuickAppTute))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appQtQuickAppTute)() {
    return 1;
}
