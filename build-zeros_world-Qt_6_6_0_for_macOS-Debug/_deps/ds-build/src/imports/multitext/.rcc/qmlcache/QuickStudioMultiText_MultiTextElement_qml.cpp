...
0x3c,0x16,0x0,0x0,0x32,0x36,0x34,0x31,
...
0x0,0x0,0x0,0x0,0x26,0x48,0xd6,0x62,
0x6a,0x44,0x1f,0x49,0x37,0x2e,0x34,0x1a,
0xeb,0xd8,0x2e,0xd4,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
;
// generate_GetLookup
while (!aotContext->getEnumLookup(13, &r2_3)) {
...
label_0:;
// generate_GetLookup
while (!aotContext->getEnumLookup(15, &r2_3)) {
...
// generate_Sub
r2_2 = QVariant::fromValue((std::move(r9_0) - std::move(r2_1)));
// generate_Ret
if (!r2_2.isValid())
